...
<figure class="fourth">
  <img src="{{ site.remote_url }}{{ site.baseurl }}/images/logo/logo.png" style="width: 210px; margin:120px 20px">
</figure>

![]({{ site.remote_url }}{{ site.baseurl }}/images/logo/logo.png){: style="width: 10%; float: center; margin: 12px"}